		...
		$.each(usernames, function(key, value) {
			...
			if(value.roomid==currentroom){
				...
				if(value.PlayerSocketId!=socket.id){
					...
					$('#players').append('<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3"><div class="col-md-12"><div class="media"><div class="media-left"><img src="'+value.Playerimg+'" class="media-object" style="width:60px"></div><div class="media-body"><h4 class="media-heading">' + value.Playerusername + ' </h4><p>India</p></div></div></div><div class="col-md-12"><div  id="'+value.PlayerSocketId+'" data-opponant="'+value.Playerusername+'" data-opponant-socketId="'+value.PlayerSocketId+'"><div class="'+value.PlayerSocketId+' div1" style="width:185px;height:255px;margin-top:5px;"></div></div></div></div>');
					$('#battleplayers').append('<div class="col-md-12" style="margin:10px;"><div class="media"><div class="media-left"><img src="'+value.Playerimg+'" class="media-object thumbnail" style="width:60px"></div><div class="media-body"><h4 class="media-heading">' + value.Playerusername + ' </h4><div id="oppbattle"></div></div></div></div>');
